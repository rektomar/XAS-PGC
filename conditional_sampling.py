...
model_path_config = {
    'qm9': '/home/rektomar/projects/MolSPN/results/training/model_checkpoint/qm9/zero_sort/dataset=qm9_model=zero_sort_order=rcm_nc=100_nr=40_backend=ptree_xnl=3_xns=20_xni=20_anl=5_ans=20_ani=20_device=cuda_lr=0.05_betas=[0.9, 0.82]_num_epochs=40_batch_size=1000_seed=0.pt',
