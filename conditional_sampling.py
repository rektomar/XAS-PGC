...
model_path_config = {
    'qm9': 'results/training/model_checkpoint/qm9/marg_sort/dataset=qm9_model=marg_sort_order=canonical_nc=512_backend=ctree_xnh=512_anh=512_device=cuda_lr=0.05_betas=[0.9, 0.82]_num_epochs=40_batch_size=256_seed=0.pt',
